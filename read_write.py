...
if __name__ == "__main__":
    ...
    plt.figure("Single diaphragm in LD chamber")
    ...
    plt.figure("Double diaphragm in LD chamber")
    ...
    membrane.plotPvsyTensileBending(P, data_diaphragm.diaphNB40_50, "Membrane Theoretical")
    rigid_membrane.plotPvsy(P, data_diaphragm.diaphNB40_50_rigid, "Rigid-membrane Theoretical")
    plt.figure("Single diaph convex vs non-convex")
    graphit("../../EXPT/readings/Single_flat_DP23_non_convex[09Jan14].xls", 0, 0, 4, "Single Flat forward non convex", "bar")
    graphit("../../EXPT/readings/Single_flat_DP23_non_convex[09Jan14].xls", 1, 0, 5, "Single Flat reverse non convex", "bar")
    graphit("../../EXPT/readings/21Oct_single_DP50_LDadjust.xls", 0, 0, 4, "Single flat diaphragm (convex 5mm stroke)", "bar")
    graphit("../../EXPT/readings_extended_stroke/8mm_stroke/single_flat[17Dec13].xls", 0, 0, 4, "Single Flat forward(convex 8mm)", "bar")
    graphit("../../EXPT/readings_extended_stroke/8mm_stroke/single_flat[17Dec13].xls", 0, 0, 5, "Single Flat reverse(convex 8mm)", "bar")
    graphit("../../EXPT/readings_extended_stroke/6mm_stroke/single_flat[28Nov13].xls", 0, 0, 4, "Single Flat trial 1(convex 6mm)", "bar")
    plt.show()
    plt.figure("Double diaph convex vs non-convex")
    graphit("../../EXPT/readings/Double_flat_DP23_non_convex[08Jan14].xls", 0, 0, 4, "Double Flat forward non convex", "bar")
    graphit("../../EXPT/readings/Double_flat_DP23_non_convex[08Jan14].xls", 1, 0, 5, "Double Flat reverse non convex", "bar")
    graphit("../../EXPT/readings_extended_stroke/8mm_stroke/double_flat[16Dec13].xls", 0, 0, 4, "Double Flat forward(convex 8mm stroke)", "bar")
    graphit("../../EXPT/readings_extended_stroke/8mm_stroke/double_flat[16Dec13].xls", 0, 0, 5, "Double Flat reverse(convex 8mm stroke)", "bar")
    graphit("../../EXPT/readings_extended_stroke/6mm_stroke/double_flat[29Nov13].xls", 0, 0, 4, "Double Flat trail 1(convex 6mm)", "bar")
    graphit("../../EXPT/readings_extended_stroke/6mm_stroke/double_flat[29Nov13].xls", 1, 0, 4, "Double Flat trail 2(convex 6 mm)", "bar")
    plt.show()